...
import backgroundImage from "/public/assets/bg1.png";

// Importez l'image si elle est locale
...
const About = () => {
   ...
   return (
      <div
         id="about"
         className="relative w-full md:h-screen p-2 flex items-center py-16  bg-center bg-no-repeat"
         style={{
            backgroundImage: `url(${backgroundImage.src})`,
         }}
      >
         {/* Overlay pour assombrir l'image si nécessaire */}

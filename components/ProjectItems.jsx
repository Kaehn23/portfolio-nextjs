...
const Projectitems = ({ title, backgroundImg, altText, projectUrl,technoUsed }) => {
   return (
      <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-green-400 rounded-xl p-4 group hover:bg-gradient-to-b from-[#ffffff] to-[#0F3]/50 border-2 border-[#0F3]/50">
         <Image
